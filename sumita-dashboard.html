...
<link href="https://fonts.googleapis.com/css2?family=DM+Serif+Display:ital@0;1&family=Inter:wght@300;400;500;600;700;800&family=Space+Mono:ital,wght@0,400;0,700;1,400&display=swap" rel="stylesheet"/>
...
:root {
  ...
  --border:  rgba(220,130,80,0.12);
  --border2: rgba(220,130,80,0.22);
  --teal:    #E8734A;
  --teal2:   #F0956E;
  --amber:   #D4A843;
  --amber2:  #EDCA72;
...
body {
  background: var(--bg);
  background-image: radial-gradient(ellipse 80% 50% at 20% 0%, rgba(232,115,74,0.07) 0%, transparent 60%),
                    radial-gradient(ellipse 60% 40% at 80% 100%, rgba(108,184,212,0.05) 0%, transparent 60%);
  color: var(--text);
...
::-webkit-scrollbar-thumb { background:rgba(232,115,74,0.2); border-radius:4px; }

@keyframes fadeUp   { from{opacity:0;transform:translateY(14px)} to{opacity:1;transform:translateY(0)} }
@keyframes pulse    { 0%,100%{opacity:1} 50%{opacity:0.25} }
@keyframes ticker   { from{transform:translateX(0)} to{transform:translateX(-50%)} }
@keyframes shimmer  { 0%{opacity:0.6} 50%{opacity:1} 100%{opacity:0.6} }
@keyframes glow     { 0%,100%{box-shadow:0 0 8px rgba(232,115,74,0.2)} 50%{box-shadow:0 0 22px rgba(232,115,74,0.55)} }
...
#sidebar {
  ...
  flex-shrink:0;
  background-image: linear-gradient(180deg, rgba(232,115,74,0.04) 0%, transparent 40%);
}
.logo {
...
.logo-icon {
  ...
  background: linear-gradient(135deg, var(--teal), #B84020);
  display:flex; align-items:center; justify-content:center;
  font-size:16px; box-shadow:0 0 22px rgba(232,115,74,0.4);
  flex-shrink:0;
}
.logo-text {
...
.nav-item.active {
  ...
  color:var(--teal2);
  box-shadow:inset 0 0 0 1px rgba(232,115,74,0.28);
}
.nav-item.active svg { filter:drop-shadow(0 0 4px rgba(232,115,74,0.65)); }
...
.avatar {
  ...
  background:linear-gradient(135deg, rgba(232,115,74,0.25), rgba(212,168,67,0.2));
...
.btn-new {
  ...
  box-shadow:inset 0 0 0 1px rgba(232,115,74,0.35);
}
.btn-new:hover { background:rgba(232,115,74,0.32); transform:translateY(-1px); }
...
.badge-green {
  ...
  background:rgba(61,191,138,0.12); color:var(--green);
  border-radius:6px; padding:3px 9px; font-size:11px; font-weight:700;
  font-family:var(--mono);
}
.badge-red {
  background:rgba(232,70,90,0.12); color:var(--red);
  border-radius:6px; padding:3px 9px; font-size:11px; font-weight:700;
...
.period-btn.active { background:rgba(232,115,74,0.18); color:var(--teal2); }
...
.credit-card {
  ...
  background:linear-gradient(135deg,#1A0E0A 0%,#120805 55%,#080300 100%);
...
.cc-glow2 { position:absolute; bottom:-50px; left:-30px; width:150px; height:150px; border-radius:50%; background:radial-gradient(circle,rgba(108,184,212,0.08),transparent 70%); pointer-events:none; }
...
.progress-fill  { height:100%; border-radius:4px; background:linear-gradient(90deg,var(--teal),var(--amber)); box-shadow:0 0 8px rgba(232,115,74,0.4); }
...
.ai-icon {
  width:36px; height:36px; border-radius:10px;
  background:linear-gradient(135deg,rgba(232,115,74,0.18),rgba(245,166,35,0.18));
  border:1px solid rgba(232,115,74,0.2);
  display:flex; align-items:center; justify-content:center;
}
...
.btn-ai {
  ...
  background:rgba(232,115,74,0.12); color:var(--teal2);
  font-size:11.5px; font-weight:700; cursor:pointer;
  transition:all 0.2s; font-family:var(--font);
  box-shadow:inset 0 0 0 1px rgba(232,115,74,0.22);
  display:flex; align-items:center; justify-content:center; gap:6px;
  margin-top:4px;
}
.btn-ai:hover { background:rgba(232,115,74,0.24); }
...
.w-action-btn.primary  { background:rgba(232,115,74,0.16); color:var(--teal2); box-shadow:inset 0 0 0 1px rgba(232,115,74,0.28); }
.w-action-btn.primary:hover  { background:rgba(232,115,74,0.3); }
...
.input-field:focus  { border-color:rgba(232,115,74,0.5); }
...
.send-btn {
  ...
  background:linear-gradient(135deg,var(--teal),#B84020);
  color:#FFF5EE; font-family:var(--font); font-size:14px; font-weight:800;
  cursor:pointer; transition:all 0.2s; letter-spacing:-0.01em;
  box-shadow:0 8px 24px rgba(232,115,74,0.3);
}
.send-btn:hover { transform:translateY(-1px); box-shadow:0 12px 32px rgba(232,115,74,0.4); }
...
.toggle-sw.on { background:rgba(232,115,74,0.35); }
...
.profile-avatar-lg {
  ...
  background:linear-gradient(135deg,rgba(232,115,74,0.3),rgba(212,168,67,0.3));
...
.profile-plan-badge { display:inline-flex; align-items:center; gap:5px; background:rgba(232,115,74,0.1); color:var(--teal); border-radius:6px; padding:3px 10px; font-size:10px; font-weight:700; margin-top:6px; font-family:var(--mono); }
.edit-profile-btn {
  ...
  box-shadow:inset 0 0 0 1px rgba(232,115,74,0.22); transition:all 0.2s;
}
.edit-profile-btn:hover { background:rgba(232,115,74,0.25); }

.danger-btn {
  padding:9px 20px; border-radius:10px; border:none;
  background:rgba(232,70,90,0.1); color:var(--red);
  font-family:var(--font); font-size:12px; font-weight:700; cursor:pointer;
  box-shadow:inset 0 0 0 1px rgba(232,70,90,0.2); transition:all 0.2s;
}
.danger-btn:hover { background:rgba(232,70,90,0.2); }
...
<nav id="sidebar">
  ...
  <div class="sidebar-footer">
    <div class="user-card">
      ...
      <div>
        <div class="user-name">Sumita Lama</div>
...
<div id="main">
  ...
  <div id="header">
    <div class="header-title">
      <h1 id="headerTitle">Good morning, Sumita 👋</h1>
      <p id="headerSub">Saturday, 30 May 2026 &nbsp;·&nbsp; Markets are Live</p>
    </div>
  ...
  <div id="sec-dashboard" class="section-view active">
    ...
    <div class="grid4">
      <div class="card stat-card" style="animation-delay:0.1s">
        <div class="stat-header">
          ...
          <div class="stat-icon" style="background:rgba(232,115,74,0.1);border:1px solid rgba(232,115,74,0.2)">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#E8734A" stroke-width="2.2"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>
          </div>
        </div>
      ...
      <div class="card stat-card" style="animation-delay:0.15s">
        <div class="stat-header">
          ...
          <div class="stat-icon" style="background:rgba(245,166,35,0.1);border:1px solid rgba(245,166,35,0.2)">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#D4A843" stroke-width="2.2"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>
          </div>
        </div>
      ...
      <div class="card stat-card" style="animation-delay:0.2s">
        <div class="stat-header">
          ...
          <div class="stat-icon" style="background:rgba(108,184,212,0.1);border:1px solid rgba(108,184,212,0.2)">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#6CB8D4" stroke-width="2.2"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg>
          </div>
        </div>
      ...
      <div class="card stat-card" style="animation-delay:0.25s">
        <div class="stat-header">
          ...
          <div class="stat-icon" style="background:rgba(232,70,90,0.1);border:1px solid rgba(232,70,90,0.2)">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#E8465A" stroke-width="2.2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
          </div>
        </div>
    ...
    <div class="grid-left-right">
      ...
      <div class="card insights-card">
        <div class="ai-header">
          <div class="ai-icon">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#E8734A" stroke-width="2.2"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/></svg>
          </div>
        ...
        <div class="insight-item">
          <div class="insight-icon" style="background:rgba(232,115,74,0.12);border:1px solid rgba(232,115,74,0.2)">
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#E8734A" stroke-width="2.5"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/></svg>
          </div>
          <div style="flex:1">
            <div style="display:flex;align-items:center"><span class="insight-title">Portfolio Momentum</span><span class="insight-tag" style="color:var(--teal);background:rgba(232,115,74,0.12)">Positive</span></div>
        ...
        <div class="insight-item">
          <div class="insight-icon" style="background:rgba(245,166,35,0.1);border:1px solid rgba(245,166,35,0.2)">
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#D4A843" stroke-width="2.5"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>
          </div>
          <div style="flex:1">
        ...
        <div class="insight-item">
          <div class="insight-icon" style="background:rgba(108,184,212,0.12);border:1px solid rgba(108,184,212,0.2)">
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#6CB8D4" stroke-width="2.5"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
          </div>
          <div style="flex:1">
            <div style="display:flex;align-items:center"><span class="insight-title">Spending Pattern</span><span class="insight-tag" style="color:var(--sky);background:rgba(108,184,212,0.12)">Insight</span></div>
            <div class="insight-desc">Subscriptions up 23% vs last month — 12 active recurring payments detected.</div>
          </div>
        </div>
        <div class="insight-item">
          <div class="insight-icon" style="background:rgba(232,70,90,0.1);border:1px solid rgba(232,70,90,0.2)">
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#E8465A" stroke-width="2.5"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>
          </div>
          <div style="flex:1">
            <div style="display:flex;align-items:center"><span class="insight-title">Risk Exposure</span><span class="insight-tag" style="color:var(--red);background:rgba(232,70,90,0.1)">Warning</span></div>
    ...
    <div class="grid2">
      ...
      <div class="card" style="padding:22px">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px">
          <div style="background:rgba(232,115,74,0.07);border:1px solid rgba(232,115,74,0.12);border-radius:13px;padding:14px">
          ...
          <div style="background:rgba(232,70,90,0.07);border:1px solid rgba(232,70,90,0.12);border-radius:13px;padding:14px">
          ...
          <div style="background:rgba(108,184,212,0.07);border:1px solid rgba(108,184,212,0.12);border-radius:13px;padding:14px">
    ...
    <div class="grid2">
      <div class="card">
        <div class="profile-header">
          <div class="profile-avatar-lg">SL</div>
          <div>
            <div class="profile-name">Sumita Lama</div>
            <div class="profile-email">sumita.lama@arcwealth.in</div>
        ...
        <div style="padding:0 12px 12px">
          ...
          <div class="settings-row" onclick="showToast('Personal Info','var(--teal2)')">
            <div class="settings-icon" style="background:rgba(232,115,74,0.1);border:1px solid rgba(232,115,74,0.18)">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#E8734A" stroke-width="2.2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
            </div>
          ...
          <div class="settings-row" onclick="showToast('Security settings','var(--amber2)')">
            <div class="settings-icon" style="background:rgba(245,166,35,0.1);border:1px solid rgba(245,166,35,0.18)">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#D4A843" stroke-width="2.2"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
            </div>
            <div><div class="settings-label">Security</div><div class="settings-sub">2FA, biometrics, PIN</div></div>
            <div class="settings-arrow"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><polyline points="9 18 15 12 9 6"/></svg></div>
          </div>
          <div class="settings-row">
            <div class="settings-icon" style="background:rgba(108,184,212,0.1);border:1px solid rgba(108,184,212,0.18)">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#6CB8D4" stroke-width="2.2"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg>
            </div>
          ...
          <div class="settings-row">
            <div class="settings-icon" style="background:rgba(232,115,74,0.1);border:1px solid rgba(232,115,74,0.18)">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#E8734A" stroke-width="2.2"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>
            </div>
          ...
          <div class="settings-row" onclick="showToast('Danger zone','var(--red)')">
            <div class="settings-icon" style="background:rgba(232,70,90,0.1);border:1px solid rgba(232,70,90,0.18)">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#E8465A" stroke-width="2.2"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>
            </div>
      ...
      <div style="display:flex;flex-direction:column;gap:18px">
        ...
        <div class="card" style="padding:22px">
          ...
          <div class="settings-row">
            <div class="settings-icon" style="background:rgba(232,115,74,0.1);border:1px solid rgba(232,115,74,0.18)">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#E8734A" stroke-width="2.2"><rect x="5" y="2" width="14" height="20" rx="2" ry="2"/><line x1="12" y1="18" x2="12.01" y2="18"/></svg>
            </div>
...
// ─── NAVIGATION ──────────────────────────────────────────────
const sectionTitles = {
  dashboard:   ['Good morning, Sumita 👋', 'Saturday, 30 May 2026 · Markets are Live'],
...
function updatePortfolioChart(period='1Y') {
  ...
  portfolioChart = new Chart(ctx,{
    ...
    options:{ responsive:true, maintainAspectRatio:false, plugins:{legend:{display:false}, tooltip:{ backgroundColor:BG3, borderColor:'rgba(255,255,255,0.1)', borderWidth:1, titleColor:MUTED, bodyColor:'#E8F0EF', callbacks:{ label:c=>'$'+c.raw.toLocaleString() } }},
      scales:{ x:{display:false}, y:{grid:{color:'rgba(255,255,255,0.04)'}, ticks:{color:MUTED,font:{family:'Space Mono',size:9},callback:v=>'$'+(v/1000).toFixed(0)+'K'}} }
    }
  });
}
...
// ─── TRANSACTIONS ────────────────────────────────────────────
const txns = [
  { name:'Swiggy', cat:'Food & Dining', date:'Today 11:22 AM', amt:'-₹840', pos:false, status:'completed', bg:'rgba(245,166,35,0.12)', col:'#D4A843', initials:'SW' },
  { name:'HDFC Dividend', cat:'Investment', date:'Today 09:00 AM', amt:'+$1,200', pos:true, status:'received', bg:'rgba(232,115,74,0.12)', col:'#E8734A', initials:'HD' },
  { name:'Zepto', cat:'Groceries', date:'Yesterday 07:48 PM', amt:'-₹2,140', pos:false, status:'completed', bg:'rgba(108,184,212,0.12)', col:'#6CB8D4', initials:'ZP' },
  { name:'Netflix', cat:'Subscription', date:'May 27', amt:'-$15.99', pos:false, status:'recurring', bg:'rgba(232,70,90,0.12)', col:'#E8465A', initials:'NF' },
  { name:'Freelance Pay', cat:'Income', date:'May 26', amt:'+$3,500', pos:true, status:'received', bg:'rgba(232,115,74,0.12)', col:'#E8734A', initials:'FP' },
  ...
  { name:'BTC Purchase', cat:'Crypto', date:'May 24', amt:'-$2,100', pos:false, status:'completed', bg:'rgba(245,166,35,0.12)', col:'#D4A843', initials:'₿' },
  { name:'Consulting', cat:'Income', date:'May 22', amt:'+$5,200', pos:true, status:'received', bg:'rgba(61,191,138,0.12)', col:'#3DBF8A', initials:'CS' },
];
...
// ─── CRYPTO ──────────────────────────────────────────────────
const cryptos = [
  {name:'Bitcoin',  sym:'BTC', price:67842, held:0.42, chg:3.24,  col:'#D4A843'},
  {name:'Ethereum', sym:'ETH', price:3421,  held:3.8,  chg:1.87,  col:'#E8734A'},
  {name:'Solana',   sym:'SOL', price:188,   held:45,   chg:5.12,  col:'#6CB8D4'},
  {name:'Avalanche',sym:'AVAX',price:38.5,  held:120,  chg:-2.31, col:'#E8465A'},
  {name:'Chainlink',sym:'LINK',price:18.2,  held:200,  chg:0.88,  col:'#3DBF8A'},
];
(function(){
...
const accounts = [
  ...
  { name:'CoinDCX Wallet', type:'Crypto Exchange', bal:'$28,600', chg:'+$3,800 this month', col:'#D4A843', icon:'₿' },
];
...
const recentPays = [
  ...
  { name:'Sumita Lama', amt:'+₹8,500', col:GREEN, initials:'SL' },
];
...
function initAnalytics() {
  ...
  new Chart(cfc,{type:'bar',data:{labels:mths,datasets:[{label:'Income',data:incomes,backgroundColor:hexToRgba(TEAL,0.3),borderColor:TEAL,borderWidth:1.5,borderRadius:5,order:2},{label:'Spend',data:spends,backgroundColor:hexToRgba(RED,0.25),borderColor:RED,borderWidth:1.5,borderRadius:5,order:3},{label:'Net',data:net,type:'line',borderColor:GREEN,borderWidth:2,backgroundColor:cfg,fill:true,tension:0.38,pointRadius:3,pointBackgroundColor:GREEN,order:1}]},options:{responsive:true,maintainAspectRatio:false,plugins:{legend:{labels:{color:MUTED,font:{family:'Space Mono',size:10}}},tooltip:{backgroundColor:BG3,borderColor:'rgba(255,255,255,0.1)',borderWidth:1,callbacks:{label:c=>' '+c.dataset.label+': $'+c.raw.toLocaleString()}}},scales:{x:{grid:{display:false},ticks:{color:MUTED,font:{family:'Space Mono',size:9},maxRotation:0}},y:{grid:{color:'rgba(255,255,255,0.04)'},ticks:{color:MUTED,font:{family:'Space Mono',size:9},callback:v=>'$'+(v/1000).toFixed(0)+'K'}}}}});
}
</script>
</body>
</html>
